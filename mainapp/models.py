...
class Request(models.Model):
    ...
    requestee_phone_2 = models.CharField(max_length=10,verbose_name='Requestee Phone (2) - അപേക്ഷകന്‍റെ ഫോണ്‍ നമ്പര്‍ (2)',blank=True)
    requestee_phone_3 = models.CharField(max_length=10,verbose_name='Requestee Phone (3)- അപേക്ഷകന്‍റെ ഫോണ്‍ നമ്പര്‍ (3)',blank=True)
